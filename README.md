# TotalRounds
Для парсинга используется библиотека BeautifulSoup4. Парсинг довольно сильно захардкожен, можно было сделать лучше и использовать профессиональные библиотеки для парсинга которые используют BS4.
